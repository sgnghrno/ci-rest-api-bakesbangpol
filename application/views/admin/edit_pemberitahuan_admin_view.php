  ...
  <div class="content-wrapper">
      ...
      <div class="content-header">
          <div class="container-fluid">
              <div class="row mb-2">
                  <div class="col-sm-6">
                      <h1 class="m-0 text-dark">Edit Pemberitahuan</h1>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
                      <ol class="breadcrumb float-sm-right">
                          <li class="breadcrumb-item"><a href="<?= base_url('admin'); ?>">Dashboard</a></li>
                          <li class="breadcrumb-item"><a href="<?= base_url('admin/pemberitahuan'); ?>">Pemberitahuan</a></li>
                          <li class="breadcrumb-item active"><?= $pemberitahuan['judul'] ?></li>
                      </ol>
                  </div><!-- /.col -->
              </div><!-- /.row -->
          </div><!-- /.container-fluid -->
                          ...
                          <div class="card-body table-responsive">
                              ...
                              <form action="" method="POST" enctype="multipart/form-data">
                                  <div class="form-group">
                                      ...
                                      <input id="judul" type="judul" name="judul" class="form-control" maxlength="50" placeholder="Judul Laporan" value="<?= $pemberitahuan['judul'] ?>" required>
                                      <?php echo form_error('judul', '<small class="text-danger">', '</small>'); ?>
                                  </div>
                                  <div class="form-group">
                                      <label for="deskripsi">Deskripsi</label>
                                      <textarea id="deskripsi" type="text" name="deskripsi" class="form-control" rows="5" placeholder="Deskripsi laporan" required><?= $pemberitahuan['deskripsi'] ?></textarea>
